...
def user_token_validation(userId, mobile):
    ...
    try:
        ...
        print("get_families_data user_token_validation ProgrammingError",e)  
        conn.rollback()
        return False
    except psycopg2.InterfaceError as e:
        print("get_families_data user_token_validation InterfaceError",e)
        reconnectToDB()
        return False
    finally: 
        try:
            ...
            print("get_families_data user_token_validation",e)
